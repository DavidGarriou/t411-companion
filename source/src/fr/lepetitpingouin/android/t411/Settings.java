    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnStartService.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                catch(Exception ex) {Log.e("erreur service",ex.toString());}            }
        });
        
        final CharSequence[] items = {this.getString(R.string.open_app), this.getString(R.string.update_now), this.getString(R.string.read_mails), this.getString(R.string.goto_t411), this.getString(R.string.askWhatToDo)};
        ...
        builder.setItems(items, new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface dialogInterface, int item) {
                ...
                editor.putInt("widgetAction", (int)item);
                editor.commit();
                startService(new Intent(Settings.this, t411updater.class));
