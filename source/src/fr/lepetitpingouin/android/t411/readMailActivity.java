...
public class readMailActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dialog = ProgressDialog.show(this, this.getString(R.string.getMesageContent), this.getString(R.string.pleasewait), true, true,new DialogInterface.OnCancelListener(){
            @Override
    ...
    private class mailDeleter extends AsyncTask<Void, String[], Void> {
		...
		protected void onPreExecute() {
			Toast.makeText(getApplicationContext(), readMailActivity.this.getString(R.string.pleasewait)+"...", Toast.LENGTH_SHORT).show();
			super.onPreExecute();
		}
